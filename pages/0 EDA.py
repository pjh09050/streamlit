...
with st.sidebar:
    choose = option_menu("Option", ["데이터 확인", "변수 확인", "결측치 확인", "error 변수 생성", "Total data 생성", 'Type 변환'], icons=['1-square','2-square','3-square','4-square','5-square','6-square'],menu_icon="bi bi-card-list",
        styles={
